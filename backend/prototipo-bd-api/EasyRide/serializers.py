...
class LeadSerializer(serializers.Serializer):
    """Serializer polimórfico para criação de Lead (POST /api/leads/).

    Aceita um único endpoint com o discriminador 'tipo_pessoa' para determinar
    qual sub-estrutura validar: 'dados_fisica' (FISICA) ou 'dados_juridica' (JURIDICA).
    O campo 'interesse' é obrigatório para ambos os tipos.
