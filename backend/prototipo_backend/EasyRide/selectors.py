...
from .models import Pessoa, Interesse, Modelo, Beneficio, Depoimento, Faq
...
def listar_beneficios_ativos() -> QuerySet:
    """Retorna queryset de Benefícios ativos, ordenados por 'ordem'."""
    return Beneficio.objects.filter(ativo=True)


def listar_depoimentos_ativos() -> QuerySet:
    """Retorna queryset de Depoimentos ativos, ordenados por 'ordem'."""
    return Depoimento.objects.filter(ativo=True)


def listar_faqs_ativos() -> QuerySet:
    """Retorna queryset de Perguntas Frequentes ativas, ordenadas por 'ordem'."""
